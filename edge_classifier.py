...
class EdgeClassifier:
    def __init__(self,version=2):
        embedding_paths= ['data/GloVe/glove.840B.300d.txt',
                          'data/fastText/crawl-300d-2M.vec']
        model_path = 'data/encoder/infersent{}.pkl'.format(version)
        w2v_path = embedding_paths[version-1] 
    ...
    def compare(self,x,y):
        return self.cosine(self.model.encode([x])[0], self.model.encode([y])[0])
...
# 
# print(model.compare('the cat eats.','the cat drinks.'))
